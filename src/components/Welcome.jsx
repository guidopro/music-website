      ...
      <div className="relative mt-10 mb-40 flex flex-col bg-black">
        ...
        <div className="flex justify-center">
          <p className="m-2 max-w-xl p-2 text-center text-sm text-white">
            ...
            late 2000s and early 2010s. My inspiration is rooted in the
            evocative power of film and video game music. I’m particularly drawn
            to compositions that create strong emotional landscapes, with
            composers like Vangelis, Nobuo Uematsu, Joe Hisaishi, and Hans
            Zimmer being major influences. Their ability to craft immersive,
            emotionally charged soundscapes has always resonated with me and
